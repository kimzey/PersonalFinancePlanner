...
4. เครื่องมือจำลองการลงทุน
   ...
   - ตัวเลือกพอร์ต เช่น `QQQM + SCHD`, `QQQI`, หรือกำหนดเอง
...
Net Income: 38,425 บาท

| หมวดหมู่ | จำนวนเงิน (บาท) | สัดส่วน | หมายเหตุ |
|---|---:|---:|---|
| ให้ครอบครัว + ค่าเทอมน้อง | 12,000 | 31.2% | รวมภาระค่าเทอมน้องเรียบร้อย |
| ลงทุน DCA (QQQI) | 8,000 | 20.8% | ปรับลดลงเพื่อให้ชีวิตยืดหยุ่นขึ้น |
| Fixed Tech (Net/AI) | 3,843 | 10.0% | งบเครื่องมือและซอฟต์แวร์ 10% |
| เงินออมฉุกเฉิน | 5,000 | 13.0% | สะสมสภาพคล่องรายเดือน |
| ค่าใช้จ่ายพื้นฐาน | 5,000 | 13.0% | ค่ากินและของใช้ประจำวัน |
| เงินส่วนตัว (Lifestyle) | 4,582 | 12.0% | เพิ่มความยืดหยุ่นในการใช้ชีวิต |
| รวม | 38,425 | 100.0% |  |
...
- ตัวอย่าง template:
  ...
  - `Current Plan`: ใช้แผนตั้งต้น Net Income 38,425 บาท
...
- ช่องกรอกตัวเลขรองรับนิพจน์ง่าย ๆ เช่น `12000+3500`, `38425*0.1`, `8000*12`
- รองรับ shorthand เช่น `8k`, `10k`, `1.5m`
- กด enter แล้วแปลงเป็นตัวเลขจริง
- แสดงผล preview ใต้ช่อง เช่น `10% ของ 38,425 = 3,843 บาท`
...
- Split category เช่น แยก `Lifestyle 4,582` เป็น `กินนอกบ้าน`, `ช้อปปิ้ง`, `เที่ยว`
...
4. สร้าง templates และ default financial plan จาก Net Income 38,425 บาท
...
เครื่องมือนี้ควรแสดง disclaimer ว่าเป็นการจำลองตามสมมติฐาน ไม่ใช่คำแนะนำการลงทุน ผลตอบแทนจริงของ QQQM, SCHD, QQQI หรือ ETF ใด ๆ มีความไม่แน่นอน และควรพิจารณาความเสี่ยง ค่าเงิน ภาษี ค่าธรรมเนียม และระยะเวลาการลงทุนก่อนตัดสินใจ
